...
- `scripts/app/`: application migration, smoke-test, administration, and
...
- Source audit, probe, and recovery scripts: tracked for reproducibility even
  when they are not copied into a long-lived service process.
