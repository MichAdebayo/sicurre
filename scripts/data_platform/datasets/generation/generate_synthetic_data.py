...
Usage:
    python scripts/data_platform/datasets/generation/generate_synthetic_data.py --class spam --count 10000
    python scripts/data_platform/datasets/generation/generate_synthetic_data.py --class legitimate --count 3000
    python scripts/data_platform/datasets/generation/generate_synthetic_data.py --class all
"""
