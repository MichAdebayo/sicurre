      ...
      <div className="max-w-3xl mx-auto space-y-8 relative z-10">
        ...
        >
          ...
          <section className="space-y-3">
            <h2 className="font-display font-medium text-lg text-night-text">1. Objet des CGU</h2>
          ...
          <section className="space-y-3">
            <h2 className="font-display font-medium text-lg text-night-text">2. Connexion & Intégration Cloudflare</h2>
            <p className="text-sm text-night-muted leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="font-display font-medium text-lg text-night-text">3. Engagements & Responsabilités</h2>
            <p className="text-sm text-night-muted leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="font-display font-medium text-lg text-night-text">4. Modification et Résiliation</h2>
            <p className="text-sm text-night-muted leading-relaxed">
          ...
          <section className="space-y-3">
            <h2 className="font-display font-medium text-lg text-night-text">5. Droit applicable & Juridiction</h2>
            <p className="text-sm text-night-muted leading-relaxed">
