...
#: Generation targets per class. legitimate is kept level with spam so the
#: phishing-to-legitimate ratio stays near 1.2x: a wider ratio starves the
#: legitimate class of distinct examples, whatever the loss weighting does.
#: Not 1.0, because real inboxes are not balanced either.
