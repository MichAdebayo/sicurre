...
| Bloc 2 | Technical survey and POC | benchmark, rejected options, feasibility notes, proof of concept |
| Bloc 3 | Model | classifier API, evaluation flow, model contracts, test evidence |
| Bloc 4 | App | application integration, auth, remediation flows, UI-connected endpoints |
...
| Bloc 2 | Bloc 2, C6 to C8 | benchmark, technical survey, service choice, and proof of concept |
...
- the technical survey exists in research notes but must now be treated as its own delivery bloc
